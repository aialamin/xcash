...
const categories = [
  ...
  { id: 'tv',          Icon: Tv,            label: 'Cable TV',    bg: '#F0FDF4', color: '#166534' },
        ...
        {!done && selected && cat && (
          <>
            <TouchableOpacity onPress={() => setSelected(null)}>
              <Text className="text-green-700 text-sm">← Change category</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity onPress={submit} className="bg-green-700 rounded-2xl py-3 items-center"><Text className="text-white font-bold text-lg">Pay Bill</Text></TouchableOpacity>
          </>
        )}
        {done && (
