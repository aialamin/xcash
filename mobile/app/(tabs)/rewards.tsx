...
const offers = [
  ...
  { Icon: Store,           title: 'Merchant Offer',      desc: '৳20 off at partner shops',                  tag: 'OFFER',    bg: '#F0FDF4', color: '#166534', tagBg: '#F3E8FF', tagColor: '#166534' },
  ...
  return (
    <ScrollView className="flex-1 bg-green-50" showsVerticalScrollIndicator={false}>
      ...
      <View className="p-4 pb-24 gap-3">
        <View className="rounded-2xl p-5" style={{ backgroundColor: '#166534' }}>
          <View className="flex-row items-center gap-2 mb-1">
            <Tag size={14} color="#86EFAC" />
            <Text className="text-xs text-green-200">Total Cashback Earned</Text>
          </View>
          <Text className="text-3xl font-extrabold text-white">৳0.00</Text>
          <Text className="text-xs text-green-200 mt-1">Start transacting to earn!</Text>
        </View>
